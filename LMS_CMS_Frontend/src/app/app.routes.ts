...
export const routes: Routes = [
    ...
    // },
    {
        ...
        children: [
           ...
           { path: 'Applicant registration form/Create',loadComponent: () => import('./Pages/Employee/Administrator/registered-employee-view/registered-employee-view.component').then(m => m.RegisteredEmployeeViewComponent), title: 'Applicant registration form', canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard], },
