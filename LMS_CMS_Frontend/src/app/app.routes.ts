...
export const routes: Routes = [
    ...
    { path: "EmployeeSignUp", component: SignUpEmployeeComponent, title: "EmployeeSignUp", canActivate: [noNavigateToLoginIfLoginGuard] },
    {
        ...
        children: [
            ...
            { path: "Loans Reports", component: LoansReportComponent, title: "Loans Reports", canActivate: [noNavigateWithoutLoginGuard] },
            { path: "Bonus", component: BonusComponent, title: "Bonus", canActivate: [noNavigateWithoutLoginGuard] },
            { path: "Bonus Reports", component: BonusReportComponent, title: "Bonus Reports", canActivate: [noNavigateWithoutLoginGuard] },
