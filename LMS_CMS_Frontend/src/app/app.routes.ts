...
export const routes: Routes = [
    ...
    { 
        ...
        children: [
            ...
            { path: "WorkingWeeks/:domainName/:Id", component: SemesterViewComponent, title: "Semester", canActivate:[noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard ]}, //
            ...
            { path: "Lesson Activity Types", component: LessonActivityTypeComponent, title: "Lesson Activity Type", canActivate:[noNavigateWithoutLoginGuard ] },
            { path: "Lesson Resources Types", component: LessonResourcesTypeComponent, title: "Lesson Resource Type", canActivate:[noNavigateWithoutLoginGuard ] },
            { path: "Student Medal", component: StudentMedalComponent, title: "Student Medal", canActivate:[noNavigateWithoutLoginGuard ] },
            { path: "Lessons", component: LessonComponent, title: "Lesson", canActivate:[noNavigateWithoutLoginGuard ] },
            { path: "Enter Daily Performance", component: DailyPerformanceComponent, title: "Daily Performance", canActivate:[noNavigateWithoutLoginGuard ] },
            { path: "Student Medal", component: StudentMedalComponent, title: "Student Medal", canActivate:[noNavigateWithoutLoginGuard ] },
