    ...
    // },
    {
        ...
        children: [
           ...
           // Form Master data
            ...
            // RegisteredEmployeeViewComponent
           ...
           //{ path: 'RegisteredEmployee/Create',loadComponent: () => import('./Pages/Employee/Administrator/registered-employee-view/registered-employee-view.component').then(m => m.RegisteredEmployeeViewComponent), title: 'Applicant registration form', canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard], },
{
  path: 'Applicant registration form', 
  loadComponent: () =>
    import('./Pages/Employee/Administrator/registered-employee-view/registered-employee-view.component')
      .then(m => m.RegisteredEmployeeViewComponent),
  title: 'Applicant registration form',
  canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard],
}
,
