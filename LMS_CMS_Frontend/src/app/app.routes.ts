...
export const routes: Routes = [
    ...
    { path: "EmployeeSignUp", component: SignUpEmployeeComponent, title: "EmployeeSignUp", canActivate: [noNavigateToLoginIfLoginGuard] },
    {
        ...
        canActivate: [navigateIfEmployeeGuard, noNavigateWithoutLoginGuard],
         children: [
            ...
            { path: "Hygiene Form", component: CreateHygieneFormComponent, title: "Hygiene Form", canActivate: [noNavigateWithoutLoginGuard ,  navigateIfHaveSettingPageGuard] },
            { path: 'Hygiene Form/:id', component: ViewHygieneFormComponent, title: "Hygiene Form", canActivate: [noNavigateWithoutLoginGuard ,  navigateIfHaveSettingPageGuard] },
            ...
            { path: 'Account Statement Report', component: AccountingStatementReportComponent, title: 'Account Statement Report', canActivate: [noNavigateWithoutLoginGuard],data: { reportType: 'employee' }   },
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'Student Issue Report', component: StudentIssueReportComponent, title: 'Student Issue Report', canActivate: [noNavigateWithoutLoginGuard], data: { reportType: 'parent' }  },
            { path: "Student Daily Performance Report", component: DailyPreformanceReportComponent, title: "Certificate", canActivate: [noNavigateWithoutLoginGuard] , data: { reportType: 'parent' } },
            { path: 'Conducts Report', component: ConductReportComponent, title: 'Conduct Report', canActivate: [noNavigateWithoutLoginGuard], data: { reportType: 'parent' }  },
            ...
            { path: "ShopItem/:id", component: ShopItemComponent, title: "Shop Item" },
            { path: "Cart", component: CartComponent, title: "Cart" },
            { path: "Order", component: OrderComponent, title: "Order" },
            { path: "Order/:id", component: OrderItemsComponent, title: "Order Items" },
    ...
    },
    {
        ...
        children: [
            ...
            { path: "ShopItem/:id", component: ShopItemComponent, title: "Shop Item", canActivate: [noNavigateWithoutLoginGuard, navigateIfStudentGuard] },
