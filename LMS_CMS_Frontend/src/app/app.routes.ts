...
export const routes: Routes = [
    ...
    // },
    {
        ...
        children: [
           ...
           // {path: 'titles/:id',loadComponent: () => import('./Pages/Employee/Administrator/title/title/title.component').then(m => m.TitleComponent),title: 'Titles',canActivate: [noNavigateWithoutLoginGuard] },
