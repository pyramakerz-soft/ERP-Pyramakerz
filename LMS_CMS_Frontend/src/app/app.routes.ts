...
export const routes: Routes = [
    ...
    // },
    {
        ...
        children: [
            ...
            { path: "Bank", loadComponent: () => import('./Pages/Employee/Accounting/bank/bank.component').then(m => m.BankComponent), title: "Bank", canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard] },
            ...
            { path: "Purchase Returns", loadComponent: () => import('./Pages/Employee/Inventory/inventory-master/inventory-master.component').then(m => m.InventoryMasterComponent), title: "Purchase", canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard], data: { id: 10 } },
            { path: "Purchase Returns/:FlagId", loadComponent: () => import('./Pages/Employee/Inventory/inventory-details/inventory-details.component').then(m => m.InventoryDetailsComponent), title: "Purchases Item", canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard] },
            { path: "Purchase Returns/Edit/:FlagId/:id", loadComponent: () => import('./Pages/Employee/Inventory/inventory-details/inventory-details.component').then(m => m.InventoryDetailsComponent), title: "Purchases Item", canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard] },
            ...
            { path: "Addition Adjustment", loadComponent: () => import('./Pages/Employee/Inventory/inventory-master/inventory-master.component').then(m => m.InventoryMasterComponent), title: "Addition", canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard], data: { id: 3 } },
            ...
            { path: "Disbursement", loadComponent: () => import('./Pages/Employee/Inventory/inventory-master/inventory-master.component').then(m => m.InventoryMasterComponent), title: "Addition", canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard], data: { id: 4 } },
            ...
            { path: "Disbursement Adjustment", loadComponent: () => import('./Pages/Employee/Inventory/inventory-master/inventory-master.component').then(m => m.InventoryMasterComponent), title: "Disbursement", canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard], data: { id: 5 } },
            ...
            { path: "Transfer to Store", loadComponent: () => import('./Pages/Employee/Inventory/inventory-master/inventory-master.component').then(m => m.InventoryMasterComponent), title: "Transfer", canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard], data: { id: 8 } },
