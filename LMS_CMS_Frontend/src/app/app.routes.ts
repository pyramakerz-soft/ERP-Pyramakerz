...
export const routes: Routes = [
    ...
    // },
    {
        ...
        children: [
            ...
            { path: "HygieneTypes", data: { pageName: "Hygiene Types" }, loadComponent: () => import('./Pages/Employee/Clinic/hygiene-types/hygiene-types.component').then(m => m.HygieneTypesComponent), title: "Hygiene Types", canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard] },
