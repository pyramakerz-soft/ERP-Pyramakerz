    ...
    { path: "EmployeeSignUp", component: SignUpEmployeeComponent, title: "EmployeeSignUp", canActivate: [noNavigateToLoginIfLoginGuard] },
    {
        ...
        canActivate: [navigateIfEmployeeGuard, noNavigateWithoutLoginGuard],
         children: [
            ...
            { path: 'Store Limited Items', component: StoreBalanceReportComponent, title: 'Announcement', data: { reportType: 'ItemsUnderLimit', title: 'Store Balance - Items Under Limit' }, canActivate: [noNavigateWithoutLoginGuard, navigateIfHaveSettingPageGuard] },
