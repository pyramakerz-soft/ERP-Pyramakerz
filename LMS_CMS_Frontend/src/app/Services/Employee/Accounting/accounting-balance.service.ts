...
//https://localhost:7205/api/with-domain/AccountBalancesReports/GetAccountBalance?toDate=2025-09-03&linkFileID=2&zeroBalance=true&positiveBalance=true&negativeBalance=true&pageNumber=1&pageSize=10
