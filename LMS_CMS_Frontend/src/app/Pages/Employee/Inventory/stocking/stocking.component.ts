...
export class StockingComponent {
  ...
  async Delete(id: number) {
    ...
    Swal.fire({
      title: this.translate.instant('Are you sure you want to') + " " + this.translate.instant('delete') + " " + this.translate.instant('هذا') + " " + this.translate.instant('Stocking') + this.translate.instant('?'),
      icon: 'warning',
