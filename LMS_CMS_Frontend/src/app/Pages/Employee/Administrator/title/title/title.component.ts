...
async Delete(id: number) {
  ...
  onSearchEvent(event: { key: string; value: any }) {
    // هنا هنجيب البيانات ونعمل filter زي الـ Department
    // (هنكمله لما نكتب الـ HTML)
  }

//  IsAllowDelete(insertedBy: number | undefined): boolean {
//   if (insertedBy === undefined || insertedBy === null) {
//     return false;
//   }
//   return this.editDeleteServ.IsAllowDelete(insertedBy, this.UserID, this.AllowDeleteForOthers);
// }

// IsAllowEdit(insertedBy: number | undefined): boolean {
//   if (insertedBy === undefined || insertedBy === null) {
//     return false;
//   }
//   return this.editDeleteServ.IsAllowEdit(insertedBy, this.UserID, this.AllowEditForOthers);
// }
}