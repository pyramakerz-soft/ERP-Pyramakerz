...
namespace LMS_CMS_PL.Controllers.Domains.HR
{
    ...
    [ApiController]
    public class BounsCategoryController : ControllerBase
    {
        private readonly DbContextFactoryService _dbContextFactory;
        IMapper mapper;
        private readonly CheckPageAccessService _checkPageAccessService;

        public BounsCategoryController(DbContextFactoryService dbContextFactory, IMapper mapper, CheckPageAccessService checkPageAccessService)
        {
        ...
        public async Task<IActionResult> GetAsync()
        {
            ...
            List<BounsCategory> categories = await Unit_Of_Work.bounsCategory_Repository.Select_All_With_IncludesById<BounsCategory>(
                    b => b.IsDeleted != true);
            ...
            List<BounsCategoryGetDTO> BuildingDTO = mapper.Map<List<BounsCategoryGetDTO>>(categories);
        ...
        public async Task<IActionResult> GetById(long id)
        {
            ...
            BounsCategory category = await Unit_Of_Work.bounsCategory_Repository.FindByIncludesAsync(t => t.IsDeleted != true && t.ID == id);
            ...
            BounsCategoryGetDTO categoryDTO = mapper.Map<BounsCategoryGetDTO>(category);
        ...
        public IActionResult Add(BounsCategoryAddDTO NewCategory)
        {
            UOW Unit_Of_Work = _dbContextFactory.CreateOneDbContext(HttpContext);
            ...
            BounsCategory category = mapper.Map<BounsCategory>(NewCategory);
        ...
        public IActionResult Edit(BounsCategoryEditeDTO NewCategory)
        {
            UOW Unit_Of_Work = _dbContextFactory.CreateOneDbContext(HttpContext);
            ...
            BounsCategory CategoryExists = Unit_Of_Work.bounsCategory_Repository.First_Or_Default(b => b.ID == NewCategory.Id && b.IsDeleted != true);
            ...
            {
                IActionResult? accessCheck = _checkPageAccessService.CheckIfEditPageAvailable(Unit_Of_Work, "Addition Category", roleId, userId, CategoryExists);
                if (accessCheck != null)
                {
                    return accessCheck;
                }
            ...
            Unit_Of_Work.bounsCategory_Repository.Update(CategoryExists);
            Unit_Of_Work.SaveChanges();
            return Ok(NewCategory);
        }
       ...
       pages: new[] { "Addition Category" }
        ...
        public async Task<IActionResult> Delete(long id)
        {
            ...
            BounsCategory category = Unit_Of_Work.bounsCategory_Repository.First_Or_Default(t => t.IsDeleted != true && t.ID == id);
            if (category == null)
            {
                return NotFound();
            }
            ...
            if (userTypeClaim == "employee")
            {
                IActionResult? accessCheck = _checkPageAccessService.CheckIfDeletePageAvailable(Unit_Of_Work, "Addition Category", roleId, userId, category);
                if (accessCheck != null)
                {
                    return accessCheck;
                }
            ...
            Unit_Of_Work.bounsCategory_Repository.Update(category);
            Unit_Of_Work.SaveChanges();
            return Ok();
