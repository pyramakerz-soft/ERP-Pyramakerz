...
namespace LMS_CMS_PL.Controllers.Domains.HR
{
    ...
    public class SalaryReportsController : ControllerBase
    {
        ...
        [Authorize_Endpoint_(
          ...
          pages: new[] { "Employee Salary Detailed Report" }
         )]
        ...
        [Authorize_Endpoint_(
         allowedTypes: new[] { "octa", "employee" },
          pages: new[] { "HR Attendance Report" }
        )]
        ...
        [Authorize_Endpoint_(
         allowedTypes: new[] { "octa", "employee" },
          pages: new[] { "Salary Summary Report" }
        )]
        ...
        [HttpGet("GetEmployeeSalaryDetailedByToken/{month}/{year}")]
        [Authorize_Endpoint_(
          allowedTypes: new[] { "octa", "employee" },
          pages: new[] { "My Salary Detailed" }
         )]
        public async Task<IActionResult> GetEmployeeSalaryDetailedByToken(int month, int year)
        {
            UOW Unit_Of_Work = _dbContextFactory.CreateOneDbContext(HttpContext);
        ...
        [HttpGet("GetAttendanceByToken/{month}/{year}")]
        [Authorize_Endpoint_(
         allowedTypes: new[] { "octa", "employee" },
          pages: new[] { "My Attendance" }
        )]
        public async Task<IActionResult> GetAttendanceByToken(int month, int year)
        {
            UOW Unit_Of_Work = _dbContextFactory.CreateOneDbContext(HttpContext);
        ...
        [HttpGet("GetSalarySummaryByToken/{month}/{year}")]
        [Authorize_Endpoint_(
         allowedTypes: new[] { "octa", "employee" },
          pages: new[] { "My Salary Summary" }
        )]
        public async Task<IActionResult> GetSalarySummaryByToken(int month, int year)
        {
            UOW Unit_Of_Work = _dbContextFactory.CreateOneDbContext(HttpContext);
            ...
            SalaryHistory SalaryHistory = Unit_Of_Work.salaryHistory_Repository.First_Or_Default(m => m.Month == month && m.Year == year && m.EmployeeId == EmpId);
            ...
            SalaryHistoryGetDTO SalaryHistoryGetDTO = mapper.Map<SalaryHistoryGetDTO>(SalaryHistory);
