...
namespace LMS_CMS_PL.Controllers.Domains.HR
{
    ...
    public class BonusController : ControllerBase
    {
        ...
        public async Task<IActionResult> EditAsync(BounsAddDTO newBouns)
        {
            ...
            {
                IActionResult? accessCheck = _checkPageAccessService.CheckIfEditPageAvailable(Unit_Of_Work, "Conduct Level", roleId, userId, bouns);
                if (accessCheck != null)
                {
                    return accessCheck;
                }
        ...
        public IActionResult Delete(long id)
        {
            ...
            if (userTypeClaim == "employee")
            {
                IActionResult? accessCheck = _checkPageAccessService.CheckIfDeletePageAvailable(Unit_Of_Work, "Conduct Level", roleId, userId, bouns);
                if (accessCheck != null)
                {
                    return accessCheck;
                }
