...
namespace LMS_CMS_PL.Controllers.Domains.Clinic
{
    ...
    public class DiagnosisController : ControllerBase
    {
        ...
        public DiagnosisController(DbContextFactoryService dbContextFactory, IMapper mapper, CheckPageAccessService checkPageAccessService)
        {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            List<Diagnosis> diagnosis = await Unit_Of_Work.diagnosis_Repository
                .Select_All_With_IncludesById<Diagnosis>(
                t => t.IsDeleted != true,
        ...
        public async Task<IActionResult> GetByID(long id)
        {
            ...
            Diagnosis diagnosis = await Unit_Of_Work.diagnosis_Repository
                .FindByIncludesAsync(
        ...
        public IActionResult Update(DiagnosisPutDTO diagnosisDto)
        {
            ...
            {
                IActionResult? accessCheck = _checkPageAccessService.CheckIfEditPageAvailable(Unit_Of_Work, "Diagnosis", roleId, userId, diagnosis);
                if (accessCheck != null)
                {
                    return accessCheck;
                }
        ...
        public IActionResult Delete(long id)
        {
            ...
            if (userTypeClaim == "employee")
            {
                IActionResult? accessCheck = _checkPageAccessService.CheckIfDeletePageAvailable(Unit_Of_Work, "Diagnosis", roleId, userId, diagnosis);
                if (accessCheck != null)
                {
                    return accessCheck;
                }
