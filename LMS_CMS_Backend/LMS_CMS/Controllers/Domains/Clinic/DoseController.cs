...
namespace LMS_CMS_PL.Controllers.Domains.Clinic
{
    ...
    public class DoseController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            List<Dose> dose = await Unit_Of_Work.dose_Repository
                .Select_All_With_IncludesById<Dose>(
                d => d.IsDeleted != true, 
        ...
        public async Task<IActionResult> GetByID(long id)
        {
            ...
            Dose dose = await Unit_Of_Work.dose_Repository.FindByIncludesAsync(
