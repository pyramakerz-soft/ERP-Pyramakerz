...
namespace LMS_CMS_PL.Controllers.Domains.Accounting
{
    ...
    public class SafeEmployeeController : ControllerBase
    {
        ...
        [Authorize_Endpoint_(
            allowedTypes: new[] { "octa", "employee" },
            pages: new[] { "Safe" , "Loans" , "Receivable", "Payable", "Sales Returns", "Sales", "Purchase Returns", "Purchase Order", "Purchases", "Opening Balances", "Addition", "Damaged", "Transfer to Store", "Gifts", "Disbursement Adjustment"
                , "Disbursement", "Addition Adjustment"  }
        )]
