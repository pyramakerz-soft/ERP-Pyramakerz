...
namespace LMS_CMS_PL.Controllers.Domains.Accounting
{
    ...
    public class BankEmplloyeeController : ControllerBase
    {
        ...
        [Authorize_Endpoint_(
            ...
            pages: new[] { "Bank", "Receivable", "Payable", "Sales Returns", "Sales", "Purchase Returns", "Purchase Order", "Purchases", "Opening Balances", "Addition", "Damaged", "Transfer to Store", "Gifts", "Disbursement Adjustment", "Disbursement", "Addition Adjustment" }
        )]
