...
{
    /// <inheritdoc />
    public partial class SPEdits : Migration
    {
        /// <inheritdoc />
                   ...
                   BEGIN
                       ...
                       BEGIN
                           ...
                           BEGIN
                               ...
                               -- Official holiday?
                               IF EXISTS (SELECT 1 FROM OfficialHolidays OH WHERE OH.DateFrom <= @Day AND OH.DateTo >= @Day AND (IsDeleted IS NULL OR IsDeleted != 1))
                               BEGIN
                                   ...
                                   BEGIN
									   ...
									   SET @WorkingHours = @WorkedMinsHoliday / 60;
                                       SET @WorkingMinutes = @WorkedMinsHoliday % 60;
                                   END
                               END
                               ...
                               BEGIN
                                   ...
                                   BEGIN
									   ...
									   SET @WorkingHours = @WorkedMinsWeekend / 60;
                                       SET @WorkingMinutes = @WorkedMinsWeekend % 60;
                                   END
                               END
