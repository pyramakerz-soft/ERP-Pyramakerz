...
namespace LMS_CMS_BL.DTO.Communication
{
    public class RequestGetDTO
    {
        ...
        public string ForwardedToEnglishName { get; set; }
        public string ForwardedToArabicName { get; set; }
        public long? ForwardedFromID { get; set; }
        public string ForwardedFromEnglishName { get; set; }
        public string ForwardedFromArabicName { get; set; }
